...
mixin _$GoalModel {
 ...
 String get id; String get uid; String get title; double get targetAmount; double get currentAmount; DateTime get deadline; bool get isCompleted;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,uid,title,targetAmount,currentAmount,deadline,isCompleted);

@override
String toString() {
  return 'GoalModel(id: $id, uid: $uid, title: $title, targetAmount: $targetAmount, currentAmount: $currentAmount, deadline: $deadline, isCompleted: $isCompleted)';
}
...
@useResult
$Res call({
 String id, String uid, String title, double targetAmount, double currentAmount, DateTime deadline, bool isCompleted
});
...
/// Create a copy of GoalModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? uid = null,Object? title = null,Object? targetAmount = null,Object? currentAmount = null,Object? deadline = null,Object? isCompleted = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String uid,  String title,  double targetAmount,  double currentAmount,  DateTime deadline,  bool isCompleted)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GoalModel() when $default != null:
return $default(_that.id,_that.uid,_that.title,_that.targetAmount,_that.currentAmount,_that.deadline,_that.isCompleted);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String uid,  String title,  double targetAmount,  double currentAmount,  DateTime deadline,  bool isCompleted)  $default,) {final _that = this;
switch (_that) {
case _GoalModel():
return $default(_that.id,_that.uid,_that.title,_that.targetAmount,_that.currentAmount,_that.deadline,_that.isCompleted);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String uid,  String title,  double targetAmount,  double currentAmount,  DateTime deadline,  bool isCompleted)?  $default,) {final _that = this;
switch (_that) {
case _GoalModel() when $default != null:
return $default(_that.id,_that.uid,_that.title,_that.targetAmount,_that.currentAmount,_that.deadline,_that.isCompleted);case _:
  return null;
...
class _GoalModel implements GoalModel {
  const _GoalModel({required this.id, required this.uid, required this.title, required this.targetAmount, this.currentAmount = 0.0, required this.deadline, this.isCompleted = false});
...
/// Create a copy of GoalModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? uid = null,Object? title = null,Object? targetAmount = null,Object? currentAmount = null,Object? deadline = null,Object? isCompleted = null,}) {
